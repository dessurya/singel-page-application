								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered no-footer">
										...
										<tbody>
											...
											<tr>
												<td>{{ $loop }}</td>
												<td>{{ $result['true'][($loop-1)]['email'] }}</td>
												<td>{{ $result['true'][($loop-1)]['name'] }}</td>
												<td>{{ $result['true'][($loop-1)]['gender'] }}</td>
												<td>{{ $result['true'][($loop-1)]['phone'] }}</td>
											</tr>
											@endfor
										</tbody>
									</table>
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered no-footer">
										...
										<tbody>
											...
											<tr>
												<td>{{ $loop }}</td>
												<td>{{ $result['false'][($loop-1)]['email'] }}</td>
												<td>{{ $result['false'][($loop-1)]['name'] }}</td>
												<td>{{ $result['false'][($loop-1)]['gender'] }}</td>
												<td>{{ $result['false'][($loop-1)]['phone'] }}</td>
												<td>{{ $result['false'][($loop-1)]['info'] }}</td>
											</tr>
											@endfor
										</tbody>
									</table>
